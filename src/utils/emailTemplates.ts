...
export const getVerifyEmailTemplate = (url: string, to: string) => ({
  subject: EMAIL_REGISTER_USER_SUBJECT,
  text: `Click on the link to verify your email address: ${url}`,
  html: `<!DOCTYPE html>
<html lang="en" >
<head>
    <meta charset="UTF-8">
    <title>${EMAIL_REGISTER_USER_SUBJECT}</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="header">
        <img src="https://storage.googleapis.com/download/storage/v1/b/sucodev-prod/o/logo_app.png?generation=1722488176447065&alt=media"
             alt="1Key Logo">
    </div>
    <div class="content">
        <h2>${EMAIL_REGISTER_USER_SUBJECT}</h2>
        <p>${EMAIL_REGISTER_USER_CONTENT_1_1}</p>
        <p>${EMAIL_REGISTER_USER_CONTENT_1_2}</p>
        <p>
    ...
    <div class="footer">
        <div>
            ...
            <p class="small-text">This email was sent to <span> ${to}</span>. </p>
        </div>
    </div>
</div>
</body>
