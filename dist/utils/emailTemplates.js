...
<head>
    <meta charset="UTF-8">
    <title th:text="#{email.register.user.subject}"></title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="header">
        <img th:src="@{'https://storage.googleapis.com/download/storage/v1/b/sucodev-prod/o/logo_app.png?generation=1722488176447065&alt=media'}"
             alt="1Key Logo">
    </div>
    <div class="content">
        <h2 th:text="#{email.register.user.subject}"></h2>
        <p th:text="#{email.register.user.content.1.1}"></p>
        <p th:text="#{email.register.user.content.1.2}"></p>
        <p>
            We need to verify your email address to complete your 1KEY account setup.
        </p>
        <p>
            Your verify code: <strong th:text="${123}"></strong>
        </p>
    </div>
    <div class="footer">
        <div>
            <p>&copy; 1Key. All Rights Reserved.</p>
            <p class="small-text">This email was sent to <span th:text="${"phuphuoc110203@gmail.com"}"></span>. </p>
        </div>
    </div>
</div>
</body>
